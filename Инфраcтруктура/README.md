### Доработка ролей Ansible локально с использование Vagrant.
____
...
<details>
  <summary>Решение</summary>
    ...
    1. База данных и приложения вынесены на отдельные инстансы
    2. Конфигурация разделена по файлам
    3. Добавлены отдельные модули для DB и app
    4. Созданы окружения для stage и prod
